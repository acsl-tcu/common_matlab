...
%ロードした結果を書く場合
    ...
    % pc1:log1{1,1}に牽引物、log1{2,1}に1機目、log1{3.1}に2機目で3×1のcell配列になる
    % pc2:log2{1,1}に牽引物、log2{2,1}に3機目、log2{3.1}に4機目で3×1のcell配列になる
    % loggers=[ log1; log2(2:end)]とするとloggersの中は{1,1}に牽引物、{2,1}に1機目、{3,1}に2機目、{4,1}に3機目、{5,1}に4機目で5×1のcell配列になる
    if 1
        loggers = [
