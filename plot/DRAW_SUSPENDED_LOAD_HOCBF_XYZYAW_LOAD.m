classdef DRAW_SUSPENDED_LOAD_HOCBF_XYZYAW_LOAD
    ...
    methods
        function obj = DRAW_SUSPENDED_LOAD_HOCBF_XYZYAW_LOAD(logger, varargin)
            ...
            try
                obs_list = ENVIRONMENT_OBSTACLE_HOCBF_LOAD_XYZYAW();
