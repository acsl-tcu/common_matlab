function Controller= Controller_HLKMEC(dt)
% 階層型線形化コントローラの設定
...
Controller.F2=lqrd(diag([1,1,1],1),[0;0;0;1],diag([1500,1000,200,1]),[0.01],dt); % xdiag([100,10,10,1])
Controller.F3=lqrd(diag([1,1,1],1),[0;0;0;1],diag([1500,1000,200,1]),[0.01],dt); % ydiag([100,10,10,1])
Controller.F4=lqrd([0 1;0 0],[0;1],diag([300,10]),[0.001],dt);                       % ヨー角 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
