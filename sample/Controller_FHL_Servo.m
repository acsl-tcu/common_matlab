...
Controller.F2=lqrd([Ac4,zeros(4,1);-Cc4,0],[Bc4;0],diag([3000,2000,200,1,0.001]),0.1,dt); % xdiag([100,10,10,1])
Controller.F3=lqrd([Ac4,zeros(4,1);-Cc4,0],[Bc4;0],diag([3000,2000,200,1,0.001]),0.1,dt); % ydiag([100,10,10,1])
