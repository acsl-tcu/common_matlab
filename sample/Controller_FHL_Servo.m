...
Controller.F1=lqrd([Ac2,zeros(2,1);-Cc2,0],[Bc2;0],diag([100,10,0.01]),[1],dt);                                % 
Controller.F2=lqrd([Ac4,zeros(4,1);-Cc4,0],[Bc4;0],diag([3000,2000,200,1,0.001]),0.075,dt); % xdiag([100,10,10,1])
Controller.F3=lqrd([Ac4,zeros(4,1);-Cc4,0],[Bc4;0],diag([3000,2000,200,1,0.001]),0.075,dt); % ydiag([100,10,10,1])
