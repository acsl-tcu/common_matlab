function u_trans_param = InputTransform_Thrust2Throttle_drone_KMPC(varargin)
    ...
    % u_trans_param.th_offset = 325;         % offset 3s[1021] 4s[900]　発掘[926]
      u_trans_param.gain =[600;600;600;37]; % gain : [roll pitch yaw throttle]' %不明[850;850;600;600] 4s[700;700;600;400] 複数機[700;700;600;200] 発掘[800;800;800;400]
    ...
    u_trans_param.gain_tl =[600;600;600;37]; %hov,p2p[800,800,800,500]
