...
Controller.F2=lqrd(diag([1,1,1],1),[0;0;0;1],diag([100,100,10,1]),[1],dt); % xdiag([100,10,10,1])
Controller.F3=lqrd(diag([1,1,1],1),[0;0;0;1],diag([100,100,10,1]),[1],dt); % ydiag([100,10,10,1])
Controller.F4=lqrd([0 1;0 0],[0;1],diag([100,10]),[1],dt);                       % ヨー角 
=======
% % 機体名：足柄 2025/06/09 小関チューニング %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Controller.F1=lqrd([0 1;0 0],[0;1],diag([100,1]),[1],dt);                                % z 
% Controller.F2=lqrd(diag([1,1,1],1),[0;0;0;1],diag([500,1500,200,1]),[0.001],dt); % xdiag([100,10,10,1])
% Controller.F3=lqrd(diag([1,1,1],1),[0;0;0;1],diag([500,1500,200,1]),[0.001],dt); % ydiag([100,10,10,1])
% Controller.F4=lqrd([0 1;0 0],[0;1],diag([300,10]),[0.001],dt);                       % ヨー角 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % 機体名：長門 2025/06/16
Controller.F1=lqrd([0 1;0 0],[0;1],diag([100,1]),[1],dt);                                % z 
Controller.F2=lqrd(diag([1,1,1],1),[0;0;0;1],diag([500,1500,200,1]),[0.1],dt); % xdiag([100,10,10,1])
Controller.F3=lqrd(diag([1,1,1],1),[0;0;0;1],diag([500,1500,200,1]),[0.1],dt); % ydiag([100,10,10,1])
Controller.F4=lqrd([0 1;0 0],[0;1],diag([300,10]),[0.001],dt);                       % ヨー角 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
>>>>>>> Stashed changes
