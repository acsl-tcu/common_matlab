...
% % 機体名：足柄 2025/09/24 小関チューニング %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Controller.F1=lqrd([0 1;0 0],[0;1],diag([100,10]),[1],dt);                                % z
% Controller.F2=lqrd(diag([1,1,1],1),[0;0;0;1],diag([4000,1000,200,1]),[0.05],dt); % xdiag([100,10,10,1])
% Controller.F3=lqrd(diag([1,1,1],1),[0;0;0;1],diag([4000,1000,200,1]),[0.05],dt); % ydiag([100,10,10,1])
% Controller.F4=lqrd([0 1;0 0],[0;1],diag([200,1]),[0.1],dt);                       % ヨー角
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
