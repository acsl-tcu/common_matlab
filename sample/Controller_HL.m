...
Controller.F2=lqrd(diag([1,1,1],1),[0;0;0;1],diag([2200,1000,200,1]),[0.1],dt); % xdiag([100,10,10,1])
Controller.F3=lqrd(diag([1,1,1],1),[0;0;0;1],diag([2200,1000,200,1]),[0.1],dt); % ydiag([100,10,10,1])
