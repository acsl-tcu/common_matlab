...
SimBaseMode = ["SimSuspendedLoad", "SimCooperativeSuspendedLoad", "SimSplitCooperateiveLoad",...
    ...
    "SimVehicle", "SimSuspendedLoad", "SimFHL",...
    "SimFHL_Servo", "SimLiDAR", "SimFT",...
    "SimEL", "SimMPC_Koopman","SimSuspendedLoadHOCBFlinkxy","SimSuspendedLoadHOCBFlinkz","SimSuspendedLoadHOCBFlinkxyz","SimHLCBF","SimQCSPZhengCBF","SimSuspendedLoadMRDCBF"];
...
% Setting.mode = SimBaseMode(17); % SimSuspendedLoad
Setting.mode = SimBaseMode(18); % SimSuspendedLoadMRDCBF
