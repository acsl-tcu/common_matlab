...
ExpBaseMode = ["ExpSuspendedLoad","ExpSuspendedLoadCoop","ExpTestMotiveConnection", "ExpHL", "ExpFHL", "ExpFHL_Servo", "ExpFT", "ExpEL", "ExpMPC_Koopman","ExpMPC_Koopman_kyo","ExpKQ_LMPC"];

Setting.fDebug = 1; % 1: active : for debug function
Setting.PInterval = 0.6; % sec : poling interval for emergency stop
% Setting.mode = SimBaseMode(13); % Sim
% Setting.mode = SimBaseMode(7); % SimFHL

Setting.mode = ExpBaseMode(11); % Exp
