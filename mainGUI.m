...
SimBaseMode = ["SimHL_MPC","SimSuspendedLoad","SimVoronoi", "SimHL","SimPointMass", "SimVehicle", "SimSuspendedLoad", "SimFHL", "SimFHL_Servo", "SimLiDAR", "SimFT", "SimMPC_Koopman_komatsu", "SimMPC_KMC_kyo","SimKQ_LMPC_EDMD","SimKQ_LMPC"];
...
Setting.mode = SimBaseMode(4); % Sim
