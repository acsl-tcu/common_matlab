...
clc
SimBaseMode = ["SimSuspendedLoad","SimVoronoi", "SimHL","SimMEC_K","SimPointMass", "SimVehicle","SimFHL", "SimFHL_Servo", "SimLiDAR", "SimFT", "SimEL", "SimMPC_Koopman"];
