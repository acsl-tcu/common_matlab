...
clc
SimBaseMode = ["SimHL_MPC","SimSuspendedLoad","SimVoronoi", "SimHL","SimPointMass", "SimVehicle", "SimSuspendedLoad", "SimFHL", "SimFHL_Servo", "SimLiDAR", "SimFT", "SimMPC_Koopman_komatsu", "SimMPC_KMC_kyo","SimKQ_LMPC","SimKQ_LMPC_EDMD"];
...
% Setting.mode = SimBaseMode(14); % SimFHL

% Setting.mode = ExpBaseMode(5); % Exp
Setting.mode = ExpBaseMode(13); % Exp
