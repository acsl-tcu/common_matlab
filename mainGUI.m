...
clc
SimBaseMode = ["SimSuspendedLoad","SimSplitCooperateiveLoad","SimVoronoi", "SimHL","SimPointMass", "SimVehicle", "SimSuspendedLoad", "SimFHL", "SimFHL_Servo", "SimLiDAR", "SimFT", "SimEL", "SimMPC_Koopman"];
...
Setting.mode = SimBaseMode(1); % SimCoop
 

% Setting.mode = ExpBaseMode(1); % ExpHL
