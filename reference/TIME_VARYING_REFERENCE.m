classdef TIME_VARYING_REFERENCE < handle
    ...
    methods
        ...
        function result = do(obj, varargin)  
           ...
           obj.result.state.q(3,1) = atan2(obj.result.state.v(2),obj.result.state.v(1));%元のやつ
           obj.result.state.q(3,1) = 0;
           % disp(atan2(obj.result.state.v(2),obj.result.state.v(1)))
           result = obj.result;
        end
