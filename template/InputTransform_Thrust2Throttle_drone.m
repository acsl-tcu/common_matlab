function u_trans_param = InputTransform_Thrust2Throttle_drone(dt, varargin)
    ...
    u_trans_param.gain            = 1/dt*[10;10;10;0.5];
    u_trans_param.gain_tl         = 1/dt*[10;10;10;0.5]; % gain : [roll pitch yaw throttle]'
