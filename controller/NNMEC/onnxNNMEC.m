classdef onnxNNMEC < handle
    ...
    methods
        function obj = onnxNNMEC(self, NN_model_filename, opts)
            arguments
                self % agent
                NN_model_filename
            ...
            if endsWith(obj.NN_model_filename, ".onnx")
                ...
                onnxPath = fullfile("\NNMEC\NN_Model\onnx\", obj.NN_model_filename+".onnx");
            end
            NN_model = importNetworkFromONNX(onnxPath,... % ONNXファイルインポート
