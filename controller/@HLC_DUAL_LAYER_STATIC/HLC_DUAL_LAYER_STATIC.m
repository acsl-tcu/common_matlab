classdef HLC_DUAL_LAYER_STATIC < HLC_SUSPENDED_LOAD_ELLIPSOID_CBF
    % =========================================================================
    ...
    methods
        function obj = HLC_DUAL_LAYER_STATIC(self, param)
            obj@HLC_SUSPENDED_LOAD_ELLIPSOID_CBF(self, param);
            obj.p_off  = zeros(3,1);
            obj.v_off  = zeros(3,1);
            obj.a_off  = zeros(3,1);
            obj.j_off  = zeros(3,1);
        ...
        function result = do(obj, time, varargin)
            ...
            obs_list = ENVIRONMENT_OBSTACLE_ELLIPSOID(); % 動的障害物モデルに変更
            F_rep = zeros(3,1);
            ...
            result = do@HLC_SUSPENDED_LOAD_ELLIPSOID_CBF(obj, time, varargin{:});
