...
agent.reference.set_function_class("timevarying", TIME_VARYING_REFERENCE(agent,{"gen_ref_saddle",{"freq",5,"orig",[0;0;1],"size",[2,2,0.5]},"HL"}));
agent.controller.set_function_class("fhl_servo", FUNCTIONAL_HLC_SERVO(agent, Controller_FHL_Servo(dt)));
run("ExpBase");
function dfunc(app)
