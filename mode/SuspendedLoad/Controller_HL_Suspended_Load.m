...
if class(agent.plant)~="DRONE_EXP_MODEL"
    ...
    Controller.F1 = lqrd([0 1;0 0],[0;1],diag([100,1]),[1],dt);             %位置z、速度z
    Controller.F2 = lqrd(A6,B6,diag([100000,300000,80000,1,0.001,0.001]),0.05,dt);%より制御周期速くなると0.008とかが良くなると思う．
    Controller.F3 = lqrd(A6,B6,diag([100000,300000,80000,1,0.001,0.001]),0.05,dt);
    Controller.F4 = lqrd([0 1;0 0],[0;1],diag([10,1]),[1],dt);
    % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
