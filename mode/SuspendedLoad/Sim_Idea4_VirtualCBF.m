...
agent.reference.set_function_class("timevarying", TIME_VARYING_REFERENCE(agent, {"gen_ref_p2p_line", {"p0", [0;0;3.0], "p1", [0;0;30], "t_go", 100.0}, 6}));
...
agent.controller.set_function_class("hlc_suspended", HLC_CBF_VIRTUAL(agent, Controller_HL_Suspended_Load(dt, agent)));
