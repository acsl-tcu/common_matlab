...
% agent.reference.bezier = BEZIER_REFERENCE(agent,{[0,0,0.6]},time);
 % agent.reference.time_var= TIME_VARYING_REFERENCE(agent,{"gen_ref_saddle",{"freq",8,"orig",[0;0;0.8],"size",[0,0,0]},"HL"});%{"Case_study_trajectory",{[0,0,0.6]},"HL"});
...
agent.reference.time_var = MY_POINT_REFERENCE(agent, {struct("f", [0;0;0.6], "g", [0;-1;0.6], "h",[-1;-1;0.6],"j",[-1;0;0.6],"k",[1;0;0.6],"z",[0;0;0.6],"x",[0;0;1.1],"c",[0;0;0.5]), 10}); % P2P
%2つのコントローラの設定---------------------------------------------------------------------------------------------------
