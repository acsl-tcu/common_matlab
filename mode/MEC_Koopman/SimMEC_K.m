...
% agent.reference.set_function_class("time_varying", TIME_VARYING_REFERENCE(agent,{"gen_ref_spline", {"point",17,"order",3,"filename",4,"ManualSetting",0,"point_dt",5,}}));
...
agent.reference.set_function_class("time_varying", TIME_VARYING_REFERENCE(agent,{"gen_ref_random", {"T",32,"start",[0;0;0.6]}}));%seedを固定すると同じ軌道，外すとランダム軌道
