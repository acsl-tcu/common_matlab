...
Controller.F1=lqrd([Ac2,zeros(2,1);-Cc2,0],[Bc2;0],diag([100,1,0.0001]),1,dt);                                % 
Controller.F2=lqrd([Ac4,zeros(4,1);-Cc4,0],[Bc4;0],diag([1500,1000,200,1,0.01]),0.05,dt); % xdiag([100,10,10,1])
Controller.F3=lqrd([Ac4,zeros(4,1);-Cc4,0],[Bc4;0],diag([1500,1000,200,1,0.01]),0.05,dt); % ydiag([100,10,10,1])
