...
if contains(type,"eul")
  ...
  Setting.dim=[13*(N+1),4*N,5 + 8*N];
  Setting.method = get_model_name("Cooperative_Load",N); % model dynamicsの実体名
  Setting.num_list = [3,4,3,3,3*N,3*N,4*N,3*N,3,3];
...
% x = [p0 Q0 v0 O0 qi wi Qi Oi a dO]
Setting.state_list =  ["p","Q","v","O","qi","wi","Qi","Oi","a","dO"];
Setting.qlist = ["Q","Qi"];
...
%Model.parameter_order = ["g","m0","j01","j02","j03","rho1_1","rho1_2","rho1_3","rho2_1","rho2_2","rho2_3","rho3_1","rho3_2","rho3_3","rho4_1","rho4_2","rho4_3","li1","li2","li3","li4","mi1","mi2","mi3","mi4","ji1_1","ji1_2","ji1_3","ji2_1","ji2_2","ji2_3","ji3_1","ji3_2","ji3_3","ji4_1","ji4_2","ji4_3"];
