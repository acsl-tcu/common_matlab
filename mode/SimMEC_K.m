...
app.logger.plot({1, "input1", ""}, "xrange",[app.time.ts,app.time.te]);
app.logger.plot({1, "input2:4", ""}, "xrange",[app.time.ts,app.time.te]);
app.logger.plot({1, "p1-p2", "er"},"color", 0,"fig_num",2);
app.logger.plot({1, "p1-p2-p3", "er"},"fig_num",3);
end