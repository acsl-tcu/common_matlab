...
app.logger.plot({1, "q", "e"},"ax",app.UIAxes,"xrange",[app.time.ts,app.time.te],"fig_num",2);
app.logger.plot({1, "v", "er"},"ax",app.UIAxes,"xrange",[app.time.ts,app.time.te],"fig_num",3);
