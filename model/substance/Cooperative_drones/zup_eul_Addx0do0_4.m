...
% Input order:
% in1 (state) = ["", "", "", "X4", "X5", "X6", "", "", "", "", "", "", "X13", "X14", "X15", "X16", "X17", "X18", "X19", "X20", "X21", "X22", "X23", "X24"];
% in2 (input) = [];
% in3 (parameter) = ["", "m0", "j01", "j02", "j03", "rho1_1", "rho1_2", "rho1_3", "rho2_1", "rho2_2", "rho2_3", "rho3_1", "rho3_2", "rho3_3", "rho4_1", "rho4_2", "rho4_3", "", "", "", "", "mi1", "mi2", "mi3", "mi4"];
