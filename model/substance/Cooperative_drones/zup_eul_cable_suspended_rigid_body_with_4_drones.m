function dX = zup_eul_cable_suspended_rigid_body_with_4_drones(x,u,P)
% Input order:
% x (state) = [];
% u (input) = [];
...
ddX = zup_eul_ddx0do0_4(x,u,P,inv(zup_eul_Addx0do0_4(x,u,P)));
dX = zup_eul_tmp_cable_suspended_rigid_body_with_4_drones(x,u,P,ddX);
end
%% 状態：
% 牽引物: 位置，姿勢角，速度，角速度，
% リンク: 角度，角速度
