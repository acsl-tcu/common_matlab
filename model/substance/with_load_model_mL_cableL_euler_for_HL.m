function dx = with_load_model_mL_cableL_euler_for_HL(in1,in2,in3)
%with_load_model_mL_cableL_euler_for_HL
%    DX = with_load_model_mL_cableL_euler_for_HL(IN1,IN2,IN3)
% Input order:
% in1 (state) = ["p1", "p2", "p3", "roll", "pitch", "yaw", "dp1", "dp2", "dp3", "o1", "o2", "o3", "pl1", "pl2", "pl3", "dpl1", "dpl2", "dpl3", "pT1", "pT2", "pT3", "ol1", "ol2", "ol3", "mL", "cableL"];
% in2 (input) = ["u1", "u2", "u3", "u4"];
% in3 (parameter) = ["m", "Lx", "Ly", "lx", "ly", "jx", "jy", "jz", "gravity", "km1", "km2", "km3", "km4", "k1", "k2", "k3", "k4", "rotor_r", "mLDummy", "cableLDummy"];
...
mt2 = [-t13.*t18.*(t71-t78);t13.*t18.*t81;0.0;0.0];
dx = [mt1;mt2];
end
